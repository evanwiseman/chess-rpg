import unittest
from src.backend.actions import Action, Spell
...
class TestAttackAction(unittest.TestCase):
    def test_create(self):
        ...
        attack_action = Action(actor, spell, target, ActionType.SPELL)
    ...
    def test_eq(self):
        ...
        actor = Entity("actor")
        target = Entity("target")
        attack_action1 = Action(actor, spell, target, ActionType.SPELL)
        attack_action2 = Action(actor, spell, target, ActionType.SPELL)
