...
if TYPE_CHECKING:
    from src.backend.core import Player
from src.backend.actions import AttackBook, SpellBook
from src.backend.entities.base import Entity
from src.backend.stats import Resource, Stat, Stats
from src.backend.systems.inventory import EquipmentManager
